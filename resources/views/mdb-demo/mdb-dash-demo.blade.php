...
<head>
    ...
    <style>
        ...
        /* Body scrollbar */
        body::-webkit-scrollbar { width: 0.8rem; } body::-webkit-scrollbar-track { border-radius: 5 px; background: #fff; } body::-webkit-scrollbar-track:hover { background: #fff; } body::-webkit-scrollbar-thumb { background: #1669f1ba; border-radius: 10px; } body::-webkit-scrollbar-thumb:hover { background: #1669f1; }
    </style>
    <style>
        body {
